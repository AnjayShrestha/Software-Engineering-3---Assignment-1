...
// for fetching category
 if ($array = $pdo->query($cate)) {
	...
	<div id="users">
		<span><?php echo '
		<a class="dropdown-item bg-light" href="admins.php?admin=category&id='.$key['category_id'].'">'.$key['category'].'<div class="dropdown-divider"></div>
		</a>'; ?></span>
  ...
  if ($array = $pdo->query($class)) {
	...
	<div id="users">
		<span><?php echo '
		<a class="dropdown-item bg-light" href="admins.php?admin=classification&id='.$key['classification_id'].'">'.$key['classification'].'<div class="dropdown-divider"></div>
		</a>'; ?></span>
...
if ($array = $pdo->query($sql)) {
	...
	<div id="users">
		<span><?php echo '
		<a class="dropdown-item bg-light" href="admins.php?admin=showAuctionDetails&id='.$key['auction_id'].'">
