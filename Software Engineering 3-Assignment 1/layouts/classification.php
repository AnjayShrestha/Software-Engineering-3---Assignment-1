...
$id = $_GET['id'];
$classification_name = $pdo->query("SELECT * FROM classification WHERE classification_id = '$id'")->fetch();session_start();
...
<body id="users">
	...
	<main id="classification" style="margin-top: 1%;margin-left: 10%; margin-right: 10%;"> 
	...
	<footer class="alert alert-secondary" style="margin-top: 16%; margin-bottom: 0;">
